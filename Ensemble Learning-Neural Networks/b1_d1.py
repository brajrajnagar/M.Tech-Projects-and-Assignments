...
param = {'max_depth':range(1,20),
            'min_samples_split':range(2,10), 'min_samples_leaf':range(1,9)}
...
clf = DecisionTreeClassifier(max_depth=3, min_samples_leaf=3, min_samples_split=4)
...
plt.savefig(dt_mammography.out_path+'/1b_DS1.jpg')



from sklearn.metrics import accuracy_score
with open(dt_mammography.out_path+'/1_b.txt', 'w+') as file1:
...
with open(dt_mammography.out_path+'/1_b.txt', 'a') as file1:
